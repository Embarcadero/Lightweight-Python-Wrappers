(**************************************************************************)
(*                                                                        *)
(* Module:  Unit 'PyPackage.Manager.Defs.Opts.Pip.Uninstall'              *)
(*                                                                        *)
(*                                  Copyright (c) 2021                    *)
...
(**************************************************************************)
unit PyPackage.Manager.Defs.Opts.Pip.Uninstall;
...
type
  TPyPackageManagerDefsOptsPipUninstall = class(TPyPackageManagerDefsOpts)
  private
    FRequirement: string;
